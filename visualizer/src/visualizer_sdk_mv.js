(function (global) {
    ...
    const visualizer = {
        ...
        carModels: [//replace this with api in future, or even json file
            { id: 'C0', name: 'Porsche 911 S/T', path: './visualizer/cdn/st.glb?v=1.0.0', brand: 'Porsche', header: '2024' },
            // { id: 'C1', name: 'Porsche 911 GT3 RS', path: './visualizer/cdn/gt3rs.glb', brand: 'Porsche', header: '2024' },
            { id: 'C2', name: 'Dodge Ram 1500', path: './visualizer/cdn/2021_ram_1500.glb?v=1.0.0', brand: 'Dodge', header: '2021'},
            { id: 'C3', name: 'Chevrolet Corvette', path: './visualizer/cdn/corvette.glb?v=1.0.0', brand: 'Chevrolet', header: '2023'},
            { id: 'C4', name: 'Ford Mustang', path: './visualizer/cdn/mustang.glb?v=1.0.0', brand: 'Ford', header: '2023'},
            { id: 'C5', name: 'Chevrolet Silverado Trail Boss', path: './visualizer/cdn/trailboss.glb?v=1.0.0', brand: 'Chevrolet', header: '2019'},
            { id: 'C6', name: 'Ford F150 Raptor', path: './visualizer/cdn/fordf150.glb?v=1.0.0', brand: 'Ford', header: '2022'},
            { id: 'C7', name: 'Porsche Cayenne', path: './visualizer/cdn/cayenne.glb?v=1.0.0', brand: 'Porsche', header: '2023'},
            { id: 'C8', name: 'Tesla Modal 3', path: './visualizer/cdn/tesla.glb?v=1.0.0', brand: 'Tesla', header: '2023'},
            { id: 'C9', name: 'Toyota 4 Runner', path: './visualizer/cdn/4runner.glb?v=1.0.0', brand: 'Toyota', header: '2024'},
