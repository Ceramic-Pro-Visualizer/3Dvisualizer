(function (global) {
    ...
    const visualizer = {
        ...
        carModels: [//replace this with api in future, or even json file
            { id: 'C0', name: 'Porsche 911 S/T', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/st.glb?v=1.0.0', brand: 'Porsche', header: '2024' },
            // { id: 'C1', name: 'Porsche 911 GT3 RS', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/gt3rs.glb', brand: 'Porsche', header: '2024' },
            { id: 'C2', name: 'Dodge Ram 1500', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/2021_ram_1500.glb?v=1.0.0', brand: 'Dodge', header: '2021'},
            { id: 'C3', name: 'Chevrolet Corvette', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/corvette.glb?v=1.0.0', brand: 'Chevrolet', header: '2023'},
            { id: 'C4', name: 'Ford Mustang', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/mustang.glb?v=1.0.0', brand: 'Ford', header: '2023'},
            { id: 'C5', name: 'Chevrolet Silverado Trail Boss', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/trailboss.glb?v=1.0.0', brand: 'Chevrolet', header: '2019'},
            { id: 'C6', name: 'Ford F150 Raptor', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/fordf150.glb?v=1.0.0', brand: 'Ford', header: '2022'},
            { id: 'C7', name: 'Porsche Cayenne', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/cayenne.glb?v=1.0.0', brand: 'Porsche', header: '2023'},
            { id: 'C8', name: 'Tesla Modal 3', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/tesla.glb?v=1.0.0', brand: 'Tesla', header: '2023'},
            { id: 'C9', name: 'Toyota 4 Runner', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/4runner.glb?v=1.0.0', brand: 'Toyota', header: '2024'},
            { id: 'C10', name: 'Ford Bronco', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/bronco.glb?v=1.0.0', brand: 'Ford', header: '2022'},
            { id: 'C11', name: 'BMW X5', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/bmw.glb?v=1.0.0', brand: 'BMW', header: '2020'},
            { id: 'C12', name: 'Porsche Taycan', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/taycan.glb?v=1.0.0', brand: 'Porsche', header: '2022'},
            { id: 'C13', name: 'Dodge Challenger', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/dodge_challenger.glb?v=1.0.0', brand: 'Dodge', header: '2022'},
            { id: 'C14', name: 'Ford F350', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/f350.glb?v=1.0.0', brand: 'Ford', header: '2022'},
            { id: 'C15', name: 'BMW M3 Competition', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/bmw_m3.glb?v=1.0.0', brand: 'BMW', header: '2022'},
            { id: 'C16', name: 'Chevy Camero', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/camero.glb?v=1.0.0', brand: 'Chevy', header: '2022'},
            { id: 'C17', name: 'GMC Sierra Competition', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/sierra.glb?v=1.0.0', brand: 'GMC', header: '2017'},
            { id: 'C18', name: 'Toyota Supra', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/supra.glb?v=1.0.0', brand: 'Toyota', header: '2018'},
            { id: 'C19', name: 'BMW X7 M60i', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/bmw_x7.glb?v=1.0.0', brand: 'BMW', header: '2020'},
        ],
        lightModels: [//replace this with api in future, or even json file
            { id: 'L0', name: 'Studio', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/skylit_garage_1k.hdr', skybox: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/skylit_garage_1k_floor_l.hdr', imgPath: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/garage_thumbnail.jpg' },
            { id: 'L1', name: 'Day', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/victoria_sunset_2k.hdr', skybox: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/victoria_sunset_2k.hdr', imgPath: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/day_thumbnail.jpg' },
            { id: 'L2', name: 'Night', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/solitude_night_1k.hdr', skybox: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/solitude_night_1k.hdr', imgPath: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/night_thumbnail.jpg' },
            { id: 'L3', name: 'Night', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/zwartkops_straight_sunset_1k.hdr', skybox: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/zwartkops_straight_sunset_1k.hdr', imgPath: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/test_thumbnail.jpg' },
            { id: 'L4', name: 'Night', path: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/rooftop_night_1k.hdr', skybox: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/rooftop_night_1k.hdr', imgPath: 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/test_thumbnail.jpg' },
        ],
        ...
        loadFonts() {
            ...
            imagePreload.href = 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/skylit_garage_1k_floor_l.hdr';
            imagePreload.rel = 'preload';
            imagePreload.as = 'image';
            document.head.appendChild(imagePreload);

            const imagePreload2 = document.createElement('link');
            imagePreload2.href = 'https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/solitude_night_1k.hdr';
        ...
        async createVisualizer(theme, darkMode) {
            ...
            modelViewer.setAttribute('src',`https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/st.glb?v=${this.cacheBuster}`);
            modelViewer.setAttribute('environment-image','https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/skylit_garage_1k.hdr');
            ...
            modelViewer.setAttribute('skybox-image','https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/skylit_garage_1k_floor_l.hdr');
        ...
        async createUI(wrapper, threeJSContainer) {
            ...
            this.carModels.sort((a, b) => a.name.localeCompare(b.name)).forEach((model) => {
            ...
            paintModule.appendChild(paintHeader);
                ...
                screenshotButton.className = 'pill';
                screenshotButton.addEventListener('click', () => {
                    const modelViewer = document.querySelector('model-viewer');
                    const dataURL = modelViewer.toDataURL('image/png'); // Or 'image/jpeg', 'image/webp'
                  const downloadLink = document.createElement('a');
                  downloadLink.href = dataURL;
                  downloadLink.download = 'model-screenshot.png';
                  downloadLink.click();
                    //Callback
                    this.triggerCallback('onScreenshot', { model : this.selectedCarModelId, paint : this.selectedPaintId, light: this.selectedLightId });
                });
                bottomBarTop.appendChild(screenshotButton);
...
grave yard
     ...
     //--------------------------- Environment Models ---------------------------//
        async createEnvironmentModel() {
            ...
            const alphaMap = textureLoader.load('https://cdn.jsdelivr.net/gh/Ceramic-Pro-Visualizer/3Dvisualizer@main/visualizer/cdn/mask_image.png');
