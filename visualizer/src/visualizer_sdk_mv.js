(function (global) {
    ...
    const visualizer = {
        ...
        carModels: [//replace this with api in future, or even json file
            { id: 'C0', name: 'Porsche 911 S/T', path: 'st.glb', brand: 'Porsche', header: '2024' },
            // { id: 'C1', name: 'Porsche 911 GT3 RS', path: 'gt3rs.glb', brand: 'Porsche', header: '2024' },
            { id: 'C2', name: 'Dodge Ram 1500', path: '2021_ram_1500.glb', brand: 'Dodge', header: '2021'},
            { id: 'C3', name: 'Chevrolet Corvette', path: 'corvette.glb', brand: 'Chevrolet', header: '2023'},
            { id: 'C4', name: 'Ford Mustang', path: 'mustang.glb', brand: 'Ford', header: '2023'},
            { id: 'C5', name: 'Chevrolet Silverado Trail Boss', path: 'trailboss.glb', brand: 'Chevrolet', header: '2019'},
            { id: 'C6', name: 'Ford F150 Raptor', path: 'fordf150.glb', brand: 'Ford', header: '2022'},
            { id: 'C7', name: 'Porsche Cayenne', path: 'cayenne.glb', brand: 'Porsche', header: '2023'},
            { id: 'C8', name: 'Tesla Modal 3', path: 'tesla.glb', brand: 'Tesla', header: '2023'},
            { id: 'C9', name: 'Toyota 4 Runner', path: '4runner.glb', brand: 'Toyota', header: '2024'},
            { id: 'C10', name: 'Ford Bronco', path: 'bronco.glb', brand: 'Ford', header: '2022'},
            { id: 'C11', name: 'BMW X5', path: 'bmw.glb', brand: 'BMW', header: '2020'},
            { id: 'C12', name: 'Porsche Taycan', path: 'taycan.glb', brand: 'Porsche', header: '2022'},
            { id: 'C13', name: 'Dodge Challenger', path: 'dodge_challenger.glb', brand: 'Dodge', header: '2022'},
            { id: 'C14', name: 'Ford F350', path: 'f350.glb', brand: 'Ford', header: '2022'},
            { id: 'C15', name: 'BMW M3 Competition', path: 'bmw_m3.glb', brand: 'BMW', header: '2022'},
            { id: 'C16', name: 'Chevy Camero', path: 'camero.glb', brand: 'Chevy', header: '2022'},
        ...
        async init({ installerId = 'mvp', targetId, darkMode = false, loadCSS = true, log = false, height = 600, width = undefined, theme = { brandColor: 'green', loaderColor: 'green' }, helpers = false, cdn = "./" }) {
            ...
            this.createVisualizer(theme, darkMode, cdn);
        ...
        loadFonts(cdn) {
            ...
            imagePreload.href = `${cdn}/skylit_garage_1k.hdr`;
            imagePreload.rel = 'preload';
            imagePreload.as = 'image';
            document.head.appendChild(imagePreload);

            const imagePreload1 = document.createElement('link');
            imagePreload1.href = `${cdn}/victoria_sunset_2k.hdr`;
            imagePreload1.rel = 'preload';
            imagePreload1.as = 'image';
        ...
        //--------------------------- Create Visualizer ---------------------------//
        async createVisualizer(theme, darkMode, cdn) {
            ...
            modelViewer.setAttribute('src',`${cdn}/st.glb`);
            modelViewer.setAttribute('environment-image', `${cdn}/skylit_garage_1k.hdr`);//default value
            ...
            modelViewer.setAttribute('skybox-image',`${cdn}/skylit_garage_1k_floor_l.hdr`);//default value
        ...
        //--------------------------- UI Overlay/Chrome ---------------------------//
        async createUI(wrapper, threeJSContainer, cdn) {
            ...
            this.carModels.sort((a, b) => a.name.localeCompare(b.name)).forEach((model) => {
                ...
                dropdownItem.addEventListener('click', (event) => {
                    ...
                    modelViewer.src = `${cdn}/${model.path}`;
            ...
            segmentedControlWrapper.appendChild(segmentedControl);
                    ...
                    segmentedControlWrapper.appendChild(colorPickerContainer);
                            ...
                            colorPickerLabel.src = `${cdn}/eyedropper-svgrepo-com.svg`;
